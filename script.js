...
function changeBg(status) {
    if (status === 'Clouds') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817817/clouds_r6ctap.jpg)';
    } else if (status === 'Rain') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817818/rainy_zoja9o.jpg)';
    } else if (status === 'Clear') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/clear_rldkhj.jpg)';
    } else if (status === 'Snow') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817818/snow_un8v3l.jpg)';
    } else if (status === 'Sunny') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817816/sunny_pgrwgn.jpg)';
    } else if (status === 'Thunderstorm') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817817/thunderstrom_rbvxip.jpg)';
    } else if (status === 'Drizzle') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817817/drizzle_pnwv1s.jpg)';
    } else if (status === 'Mist' || status === 'Haze' || status === 'Fog') {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/v1722817817/mist_pfyifb.jpg)';
    } else {
        document.body.style.backgroundImage = 'url(https://res.cloudinary.com/dp5zupqh7/image/upload/bg_vvqeeq.jpg)';
    }
}
